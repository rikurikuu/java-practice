...
public class GameList
{
    ...
    public GameList(String fp, String sp)
    {
    ...
    {
        System.out.println(new GameList("13579", "24680").play());
        System.out.println(new GameList("12345", "67890").play());
        System.out.println(new GameList("13118", "39575").play());
    }
